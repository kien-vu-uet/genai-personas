...
@mcp.tool(
    ...
    description="Talk to OpenAI O3 to brainstorm ideas.",
    tags={"brainstorm"},
)
async def brainstorm_with_openai_o3(
    *,
    ...
    try:
        ...
        assert issubclass(ExpectedOutputSchema, BaseModel), "Expected output schema must be a subclass of BaseModel"
    except Exception:
...
@mcp.tool(
    ...
    description="Talk to Gemini 2.5 Pro to brainstorm ideas.",
    tags={"brainstorm"},
)
